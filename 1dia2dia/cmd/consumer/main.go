...
func main() {
	...
	usercase := usecase.CalculateFinalPrice{OrderRepository: repository}
	...
	go kafkaWorker(msgChanKafka, usercase)
	...
	// não coloco o "go" na linha seguinte, pois prenderá o programa
